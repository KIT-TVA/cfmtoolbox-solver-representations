...
def create_assert_feature_instance_cardinality(feature: Feature, parent: Interval):
    ...
    for interval in feature.instance_cardinality.intervals:
        assertStatement += "(and "
        assertStatement += "(>= "
        assertStatement += create_const_name(feature) + " "
        assertStatement += str(interval.lower * parent.lower)
        assertStatement += ") "
        assertStatement += "(<= "
        assertStatement += create_const_name(feature) + " "
        assertStatement += str(interval.upper *  parent.upper)
        assertStatement += ") "
        assertStatement += ")"
    ...
    for interval in feature.instance_cardinality.intervals:
        for child in feature.children:
            assertStatement += create_assert_feature_instance_cardinality(child, interval)
